...
const DaySidebarEnhanced: React.FC<DaySidebarProps> = ({ isOpen, onClose, date, events }) => {
  return (
    <>
      <div
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-wrap items-center gap-3 mb-5">
                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Situacao</span>
                    ...
                    <span className={`px-3 py-1 rounded-lg border text-[11px] font-black uppercase tracking-wider ${
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed pt-4 border-t border-slate-100 italic">
                    {event.description || 'Esta atividade faz parte do cronograma oficial do EAC. Entre em contato com seu circulo para mais informacoes.'}
                  </p>
                </div>
              );
            })
...
export default DaySidebarEnhanced;
